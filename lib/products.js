...
// Ignora formatos agotados (stock === 0) al calcular el precio "desde". Si
// todos están agotados devuelve null: la UI muestra "Agotado" en su lugar.
export function precioDesde(producto) {
  const disponibles = producto.formatos.filter((f) => f.stock !== 0);
